        ...
        <v-card class="pa-4">
          ...
          <v-row>
            <v-col cols="4" md="8" class="d-flex align-center">
              <v-chip color="accent" variant="tonal" size="small">能力标识列表（只读）</v-chip>
            </v-col>
            ...
            <v-col cols="12">
              <v-card variant="outlined" color="#E0E0E0">
                <v-data-table :style="{ 'white-space': 'nowrap' }" :headers="TableHeaders" :items="tableItems"
                  :items-per-page="tableListRows" item-value="capability">
...
const TableHeaders = [
  { title: "能力标识", value: "capability" },
  { title: "描述", value: "description" },
];

// 表格状态
const tableItems = ref<CapabilityItem[]>([]);
